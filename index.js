...
const obj = new Vehicle("Tesla", "xxx", 2023, 5000);
...
Car.prototype.brake = function (numBrake) {
  this.speed -= numBrake;
...
console.log(car.toString(), car.valueOf());
...
Truck.prototype.specific = function (tow) {
  if (tow > this.towingCapacity) {
    ...
    return `Тягнення навантаження ${tow}`;
  }
};
...
console.log(truck.specific(8000));
// Викликаємо метод tow з вагою більшою за towingCapacity
console.log(truck.specific(12000));
...
const tesla = new ElectricCar("Tesls", "Model S", 2020, 10000, 100);
/*
